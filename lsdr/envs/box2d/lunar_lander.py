...
class LunarLander(gym.Env, EzPickle):
    ...
    def step(self, action):
        ...
        if (self.continuous and action[0] > 0.0) or (not self.continuous and action==2):
            ...
            p.ApplyLinearImpulse(           ( ox*self.MAIN_ENGINE_POWER*m_power,  oy*self.MAIN_ENGINE_POWER*m_power), impulse_pos, True)
        ...
        if (self.continuous and np.abs(action[1]) > 0.5) or (not self.continuous and action in [1,3]):
            ...
            p.ApplyLinearImpulse(           ( ox*self.SIDE_ENGINE_POWER*s_power,  oy*self.SIDE_ENGINE_POWER*s_power), impulse_pos, True)
